...
export const residents: Resident[] = [
  {
    ...
    status: 'Active',
    emergencyContact: 'Ramesh Patil',
    emergencyPhone: '9876543201',
    relationship: 'Son',
    address: 'Shivaji Nagar, Pune, Maharashtra',
    notes: 'Mild hypertension and type 2 diabetes. Prefers morning activities. Sensitive to noise.',
  ...
  },
  {
    ...
    status: 'Active',
    emergencyContact: 'Sunita Jadhav',
    emergencyPhone: '9876543202',
    relationship: 'Wife',
    address: 'Bhosari, Pune, Maharashtra',
    notes: 'Elevated blood pressure. Enjoys reading and playing chess. Independent with most daily activities.',
  ...
  },
  {
    ...
    status: 'Active',
    emergencyContact: 'Mahesh Shinde',
    emergencyPhone: '9876543203',
    relationship: 'Son',
    address: 'Akurdi, Pune, Maharashtra',
    notes: 'Atrial fibrillation and early-stage dementia. Requires regular blood monitoring and medication review.',
  ...
  },
  {
    ...
    status: 'Active',
    emergencyContact: 'Meena Deshmukh',
    emergencyPhone: '9876543204',
    relationship: 'Wife',
    address: 'Nigdi, Pune, Maharashtra',
    notes: 'Heart condition managed with regular medication. Previous gastric issues. Good mobility.',
  ...
  },
  {
    ...
    status: 'Active',
    emergencyContact: 'Suresh Gaikwad',
    emergencyPhone: '9876543205',
    relationship: 'Husband',
    address: 'Pimpri, Pune, Maharashtra',
    notes: 'Hypothyroidism managed with regular medication. Very sociable and participates in group activities.',
  ...
  },
  {
    ...
    dob: '1944-09-04',
    bloodGroup: 'O-',
    admissionDate: '2019-11-28',
    status: 'Active',
    emergencyContact: 'Sunanda More',
    emergencyPhone: '9876543206',
    relationship: 'Daughter',
    address: 'Chinchwad, Pune, Maharashtra',
    notes: 'Congestive heart failure. Fluid intake monitored daily. Requires assistance with mobility.',
    lastUpdate: '2026-07-10',
  },
  {
    id: '7',
    residentId: 'R-007',
    name: 'Annapurna Kulkarni',
    age: 85,
    gender: 'Female',
    dob: '1940-07-14',
    bloodGroup: 'A-',
    ...
    status: 'Active',
    emergencyContact: 'Vijay Kulkarni',
    emergencyPhone: '9876543207',
    relationship: 'Son',
    address: 'Dehu Road, Pune, Maharashtra',
    notes: 'Multiple medications. Mild depression managed with regular treatment. Enjoys knitting and devotional music.',
  ...
  },
  {
    ...
    status: 'Inactive',
    emergencyContact: 'Shobha Pawar',
    emergencyPhone: '9876543208',
    relationship: 'Wife',
    address: 'Talegaon, Pune, Maharashtra',
    notes: 'Temporarily staying with family. Type 2 diabetes. Expected to return in September 2026.',
